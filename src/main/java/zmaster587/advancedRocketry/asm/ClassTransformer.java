...
public class ClassTransformer implements IClassTransformer {
    ...
    public ClassTransformer() {
        ...
        // TODO: obf names
        // entryMap.put(CLASS_KEY_ENTITYRENDERER, new SimpleEntry<String,
        // String>("net/minecraft/client/renderer/EntityRenderer", "blt"));
        entryMap.put(CLASS_KEY_ENTITYLIVEINGBASE, new SimpleEntry<>("net/minecraft/entity/EntityLivingBase", "vp"));
        // entryMap.put(CLASS_KEY_ENTITYLIVINGRENDERER, new SimpleEntry<String,
        // String>("net/minecraft/client/renderer/entity/RendererLivingEntity", ""));
        entryMap.put(CLASS_KEY_ENTITY, new SimpleEntry<>("net/minecraft/entity/Entity", "vg"));
        entryMap.put(CLASS_KEY_ENTITY_FALLING_BLOCK,
                new SimpleEntry<>("net/minecraft/entity/item/EntityFallingBlock", "ack"));
        ...
        // entryMap.put(CLASS_KEY_ENTITY_PLAYER_SP, new SimpleEntry<String,
        // String>("net/minecraft/client/entity/EntityPlayerSP",""));
        ...
        // entryMap.put(CLASS_KEY_NETHANDLERPLAYSERVER, new SimpleEntry<String,
        // String>("net/minecraft/network/NetHandlerPlayServer",""));
        // entryMap.put(CLASS_KEY_C03PACKETPLAYER, new SimpleEntry<String,
        // String>("net/minecraft/network/play/client/C03PacketPlayer",""));
        ...
        // entryMap.put(METHOD_KEY_SETBLOCKMETADATAWITHNOTIFY, new SimpleEntry<String,
        // String>("setBlockMetadataWithNotify", "a"));
    ...
    public byte[] transform(String name, String transformedName,
         ...
         * nodeAdd.add(new FieldInsnNode(Opcodes.GETFIELD, getName(CLASS_KEY_NETHANDLERPLAYSERVER),
         * getName(FIELD_PLAYERENTITY), "L" + getName(CLASS_KEY_ENTITY_PLAYER_MP) + ";"));
         ...
         * 
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "netHandlerSetPlayerLocation", "(L" + getName(CLASS_KEY_ENTITY_PLAYER_MP) + ";DDDFFI)V", false));
         ...
         * nodeAdd.add(new VarInsnNode(Opcodes.DLOAD, 5));
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "setPosition", "(L" + getName(CLASS_KEY_ENTITYLIVEINGBASE) + ";IDDD)V", false));
         ...
         * nodeAdd.add(new FieldInsnNode(Opcodes.GETFIELD, getName(CLASS_KEY_ENTITYLIVEINGBASE), "gravRotation", "I"));
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "moveFlyingVerticalOverride", "(L" + getName(CLASS_KEY_ENTITY_PLAYER_SP) + ";I)V", false));
         ...
         * ClassNode cn = startInjection(bytes);
         * 
         * MethodNode doRender = getMethod(cn, getName(METHOD_KEY_DORENDER), "(L" +
         * getName(CLASS_KEY_ENTITYLIVEINGBASE)+";DDDFF)V");
         * 
         * if(doRender != null) {
         * final InsnList nodeAdd = new InsnList();
         * AbstractInsnNode pos = null;
         ...
         * 
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "transformEntity", "(IL" + getName(CLASS_KEY_ENTITYLIVEINGBASE) + ";)V", false));
         * 
         ...
         * ClassNode cn = startInjection(bytes);
         * 
         * MethodNode moveFlying = new MethodNode(Opcodes.ACC_PUBLIC, getName(METHOD_KEY_MOVEFLYING), "(FFF)V", null,
         * null);
         * MethodNode moveEntity = new MethodNode(Opcodes.ACC_PUBLIC, getName(METHOD_KEY_MOVEENTITY), "(DDD)V", null,
         * null);
         * MethodNode setPosition = new MethodNode(Opcodes.ACC_PUBLIC, getName(METHOD_KEY_SETPOSITION), "(DDD)V", null,
         * null);
         * 
         * 
         ...
         * moveEntityNode.add(new FieldInsnNode(Opcodes.GETFIELD, getName(CLASS_KEY_ENTITYLIVEINGBASE), "gravRotation",
         * "I"));
         ...
         * moveEntityNode.add(new MethodInsnNode(Opcodes.INVOKESPECIAL, getName(CLASS_KEY_ENTITY),
         * getName(METHOD_KEY_MOVEENTITY), "(DDD)V", false));
         ...
         * moveEntityNode.add(new VarInsnNode(Opcodes.DLOAD, 3));
         * moveEntityNode.add(new VarInsnNode(Opcodes.DLOAD, 5));
         * moveEntityNode.add(new MethodInsnNode(Opcodes.INVOKESTATIC,
         * "zmaster587/advancedRocketry/client/ClientHelper", "moveEntity", "(L" + getName(CLASS_KEY_ENTITYLIVEINGBASE)
         * + ";IDDD)V", false));
         ...
         * moveFlyingNode.add(new FieldInsnNode(Opcodes.GETFIELD, getName(CLASS_KEY_ENTITYLIVEINGBASE), "gravRotation",
         * "I"));
         ...
         * moveFlyingNode.add(new MethodInsnNode(Opcodes.INVOKESPECIAL, getName(CLASS_KEY_ENTITY),
         * getName(METHOD_KEY_MOVEFLYING), "(FFF)V", false));
         ...
         * moveFlyingNode.add(new VarInsnNode(Opcodes.FLOAD, 2));
         * moveFlyingNode.add(new VarInsnNode(Opcodes.FLOAD, 3));
         * moveFlyingNode.add(new MethodInsnNode(Opcodes.INVOKESTATIC,
         * "zmaster587/advancedRocketry/client/ClientHelper", "moveFlying", "(L" + getName(CLASS_KEY_ENTITYLIVEINGBASE)
         * + ";IFFF)V", false));
         ...
         * 
         * cn.fields.add(new FieldNode(Opcodes.ACC_PUBLIC, "gravRotation", Type.INT_TYPE.getDescriptor(), "I", new
         * Integer(1)));
         * 
         ...
         * nodeAdd.add(new VarInsnNode(Opcodes.ALOAD, 0));
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "livingEntityJump", "(IL" + getName(CLASS_KEY_ENTITYLIVEINGBASE) + ";)V", false));
         * nodeAdd.add(new InsnNode(Opcodes.RETURN));
         ...
         * nodeAdd.add(new VarInsnNode(Opcodes.ALOAD, 0));
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "transformGravity", "(IL" + getName(CLASS_KEY_ENTITYLIVEINGBASE) + ";)V", false));
         ...
         * //TODO: might break in obf
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "createModifiedLookVector", "(L" + getName(CLASS_KEY_ENTITYLIVEINGBASE) +";IF)Lnet/minecraft/util/Vec3;",
         * false));
         ...
         * 
         * nodeAdd.add(new FieldInsnNode(Opcodes.GETSTATIC, "zmaster587/advancedRocketry/client/ClientHelper", "rotate",
         * "Z"));
         * //nodeAdd.add(new VarInsnNode(Opcodes.ALOAD, 2));
         * //nodeAdd.add(new FieldInsnNode(Opcodes.GETFIELD, getName(CLASS_KEY_ENTITYLIVEINGBASE), "gravRotation",
         * "I"));
         ...
         * 
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "transformCamera2", "(IL" + getName(CLASS_KEY_ENTITYLIVEINGBASE) + ";F)V", false));
         * nodeAdd.add(new JumpInsnNode(Opcodes.GOTO, gotoLabel));
         * nodeAdd.add(gotoLabel2);
         * 
         * 
         * nodeAdd3.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "transformCamera", "()V", false));
         * nodeAdd4.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "transformCamera", "()V", false));
         * 
         * orientCamera.instructions.insertBefore(orientCamera.instructions.get(orientCamera.instructions.indexOf(pos3))
         * , nodeAdd3);
         * orientCamera.instructions.insertBefore(orientCamera.instructions.get(orientCamera.instructions.indexOf(pos3)+
         * 8), nodeAdd4);
         * 
         * orientCamera.instructions.insertBefore(orientCamera.instructions.get(orientCamera.instructions.indexOf(pos)-4
         * ), nodeAdd);
         * orientCamera.instructions.insertBefore(orientCamera.instructions.get(orientCamera.instructions.indexOf(pos2)+
         * 1), gotoLabel);
         ...
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "transformCamera", "()V", false));
         * nodeAdd2.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "transformCamera", "()V", false));
         * 
         * orientCamera.instructions.insertBefore(orientCamera.instructions.get(orientCamera.instructions.indexOf(pos)),
         * nodeAdd);
         * orientCamera.instructions.insertBefore(orientCamera.instructions.get(orientCamera.instructions.indexOf(pos)+8
         * ), nodeAdd2);
         * //TODO: OVerride Entity.setAngles
         * 
         * }
         ...
         * }
         * nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/client/ClientHelper",
         * "transformMouse", "()V", false));
         * 
         * updateCameraAndRender.instructions.insertBefore(updateCameraAndRender.instructions.get(updateCameraAndRender.
         * instructions.indexOf(pos)+1), nodeAdd);
         * 
         * }
         * 
         * return finishInjection(cn);
        ...
        if (changedName.equals(getName(CLASS_KEY_RENDER_GLOBAL)) &&
                net.minecraftforge.common.ForgeVersion.getVersion().compareTo("14.23.2.2642") < 0) {
            ClassNode cn = startInjection(bytes);
            MethodNode setupTerrain = getMethod(cn, getName(METHOD_KEY_SETUPTERRAIN),
                    "(L" + getName(CLASS_KEY_ENTITY) + ";DL" + getName(CLASS_KEY_ICAMERA) + ";IZ)V");
        ...
        if (changedName.equals(getName(CLASS_KEY_ENTITY_PLAYER_MP))) {
            ...
            if (onUpdate != null) {
                ...
                nodeAdd.add(new VarInsnNode(Opcodes.ALOAD, 0));
                nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC,
                        "zmaster587/advancedRocketry/util/RocketInventoryHelper", "allowAccess",
        ...
        if (changedName.equals(getName(CLASS_KEY_ENTITY)) ||
            ...
            if (onUpdate != null) {
                ...
                nodeAdd.add(new VarInsnNode(Opcodes.ALOAD, 0));
                nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "zmaster587/advancedRocketry/util/GravityHandler",
                        "applyGravity", "(L" + getName(CLASS_KEY_ENTITY) + ";)V", false));
        ...
        if (changedName.equals(getName(CLASS_KEY_WORLD))) {
            ClassNode cn = startInjection(bytes);
            MethodNode setBlockStateMethod = getMethod(cn, getName(METHOD_KEY_SETBLOCKSTATE),
                    "(L" + getName(CLASS_KEY_BLOCKPOS) + ";L" + getName(CLASS_KEY_IBLOCKSTATE) + ";I)Z");
            // MethodNode setBlockMetaMethod = getMethod(cn, getName(METHOD_KEY_SETBLOCKMETADATAWITHNOTIFY),
            // "(IIIII)Z");
            ...
            if (setBlockStateMethod != null) {
                ...
                nodeAdd.add(new VarInsnNode(Opcodes.ALOAD, 1));
                nodeAdd.add(new MethodInsnNode(Opcodes.INVOKESTATIC,
                        "zmaster587/advancedRocketry/atmosphere/AtmosphereHandler", "onBlockChange",
                        "(L" + getName(CLASS_KEY_WORLD) + ";L" + getName(CLASS_KEY_BLOCKPOS) + ";)V", false));
