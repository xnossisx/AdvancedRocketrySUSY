...
public interface IProtectiveArmor {
     ...
     * commitProtection true if actually running protection, this exists so that it is possible to check if an armor
     * protects
     * without performing actual item/fluid consumption. This should only be true when called from AtmosphereHandler to
     * prevent double consumtion
     */
