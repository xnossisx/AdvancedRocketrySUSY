...
public class ChunkManagerPlanet extends BiomeProvider {
    ...
    private void setup(long seed, WorldType default1, String str, DimensionProperties properties) {
        ...
        GenLayer[] agenlayer = initializeAllBiomeGenerators(seed, default1, str, properties);// GenLayer.initializeAllBiomeGenerators(seed,
                                                                                             // default1); //;
        ...
        ReflectionHelper.setPrivateValue(BiomeProvider.class, this, this.biomeIndexLayer, "biomeIndexLayer",
                "field_76945_e");
    }
    ...
    public ChunkManagerPlanet(World world, String str, List<BiomeEntry> biomes) {
        this(world.getSeed(), AdvancedRocketry.planetWorldType, str,
