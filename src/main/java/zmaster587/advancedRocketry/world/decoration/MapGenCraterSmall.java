...
public class MapGenCraterSmall extends MapGenBase {
    ...
    protected void recursiveGenerate(World world, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_,
        ...
        if (rand.nextInt(chancePerChunk) == Math.abs(chunkX) % chancePerChunk ||
                rand.nextInt(chancePerChunk) == Math.abs(chunkZ) % chancePerChunk && shouldCraterSpawn(
            ...
            int[] sinCoefficients = { rand.nextInt(15) + 1, rand.nextInt(15) + 1, rand.nextInt(15) + 1,
                ...
                for (int z = 15; z >= 0; z--) {
                    for (int y = 254; y >= 0; y--) {
                        ...
                        if (!isCraterIgnoredBlock(chunkPrimerIn.getBlockState(x, y, z).getBlock())) {
                            ...
                            int inversePartialSquareRadius = (baseRadius * baseRadius -
                                    (((xCoord * 16) + x) * ((xCoord * 16) + x) +
                            ...
                            if (baseRadius > 6) {
                                ...
                                if (inversePartialSquareRadius <= radius / 4 &&
                                        inversePartialSquareRadius > -3 * radius) {
                                    ...
                                    for (int dist = -1; dist < 9 * ridgeSize *
                                            ((1 - inversePartialSquareRadius) /
                                                    (0.8 * radius + (inversePartialSquareRadius - 1) *
                                                            (inversePartialSquareRadius - 1))) -
                                            1.06; dist++) {
                                        ...
                                        else if (y + dist < 255 && inversePartialSquareRadius > -1.125 * radius &&
                                                rand.nextInt(
                                                        Math.abs(inversePartialSquareRadius / (radius > 48 ? 4 : 2)) +
                                                                1) ==
                                                        0)
                                            chunkPrimerIn.setBlockState(x, y + dist, z,
                                                    this.getBlockToPlace(world, chunkX, chunkZ, ores));
                            ...
                            if (inversePartialSquareRadius >= 0 && (y - inversePartialSquareRadius > 0)) {
                                ...
                                chunkPrimerIn.setBlockState(x, y - inversePartialSquareRadius, z,
                                        this.getBlockToPlace(world, chunkX, chunkZ, ores));
                                chunkPrimerIn.setBlockState(x, y - 1 - inversePartialSquareRadius, z,
                                        this.getBlockToPlace(world, chunkX, chunkZ, ores));
                            }
                            break;
                        }
