...
public class MapGenSwampTree extends MapGenBase {
    ...
    // Woo hacky stuff to place these trees LIKE they were biome trees but they aren't. $@#$#@#$ walls need to go.
        ...
        for (double yAngle = 0; yAngle < 2 * Math.PI; yAngle += Math.PI / 3.0) {
            ...
            for (double angle = Math.PI; angle > 0; angle -= Math.PI / 40.0) {
                ...
                if (!cachedRoots.containsKey(new BlockPos(2 + xx - xOffset, yy - yOffset + 2, zz - zOffset)))
                    cachedRoots.put(new BlockPos(2 + xx - xOffset, yy - yOffset + 2, zz - zOffset),
                            Blocks.LOG.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y));
                if (!cachedRoots.containsKey(new BlockPos(3 + xx - xOffset, yy - yOffset + 2, zz - zOffset)))
                    cachedRoots.put(new BlockPos(3 + xx - xOffset, yy - yOffset + 2, zz - zOffset),
                            Blocks.LOG.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y));
                if (!cachedRoots.containsKey(new BlockPos(2 + xx - xOffset, yy - yOffset + 2, 1 + zz - zOffset)))
                    cachedRoots.put(new BlockPos(2 + xx - xOffset, yy - yOffset + 2, 1 + zz - zOffset),
                            Blocks.LOG.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y));
                if (!cachedRoots.containsKey(new BlockPos(2 + xx - xOffset, yy - yOffset + 3, 1 + zz - zOffset)))
                    cachedRoots.put(new BlockPos(2 + xx - xOffset, yy - yOffset + 3, 1 + zz - zOffset),
                            Blocks.LOG.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y));
                if (!cachedRoots.containsKey(new BlockPos(1 + xx - xOffset, yy - yOffset + 2, zz - zOffset)))
                    cachedRoots.put(new BlockPos(1 + xx - xOffset, yy - yOffset + 2, zz - zOffset),
                            Blocks.LOG.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y));
                if (!cachedRoots.containsKey(new BlockPos(2 + xx - xOffset, yy - yOffset + 2, zz - zOffset - 1)))
                    cachedRoots.put(new BlockPos(2 + xx - xOffset, yy - yOffset + 2, zz - zOffset - 1),
                            Blocks.LOG.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y));
            }
        }
    }
            ...
            for (double angle = 1.5 * Math.PI / 2.0; angle > -Math.PI / 6.0; angle -= Math.PI / 128.0) {
                ...
                for (int yyy = -2; yyy < 4; yyy++)
                    if (!cachedCanopy.containsKey(new BlockPos(2 + xx - xOffset, yyy + yy - yOffset + 2, zz - zOffset)))
                        cachedCanopy.put(new BlockPos(2 + xx - xOffset, yyy + yy - yOffset + 2, zz - zOffset),
                                Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false));
                // world.setBlock( x + 2 + xx - xOffset - radius/2, treeHeight -3 + yy - yOffset +2, z + zz- zOffset,
                // Blocks.vine, 0,2);
            }
    ...
    @Override
    protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int rangeX, int rangeZ,
                                     ChunkPrimer blocks) {
        if (rand.nextInt(chancePerChunk) == Math.abs(chunkX) % chancePerChunk &&
                rand.nextInt(chancePerChunk) == Math.abs(chunkZ) % chancePerChunk &&
                canSwampTreeGenerateGenerate(world, chunkX * 16, chunkZ * 16)) {
            ...
            for (double yAngle = 0; yAngle < 2 * Math.PI; yAngle += Math.PI / 8.0) {
                ...
                for (double angle = 1.5 * Math.PI / 2.0; angle > -Math.PI / 6.0; angle -= Math.PI / 40.0) {
                    ...
                    setBlock(new BlockPos(x + 2 + xx - xOffset - radius / 2, p_i46030_2_, z + zz - zOffset),
                            Blocks.LOG.getDefaultState(), blocks);
                    setBlock(new BlockPos(x + 3 + xx - xOffset - radius / 2, p_i46030_2_, z + zz - zOffset),
                            Blocks.LOG.getDefaultState(), blocks);
                    setBlock(new BlockPos(x + 1 + xx - xOffset - radius / 2, p_i46030_2_, z + zz - zOffset),
                            Blocks.LOG.getDefaultState(), blocks);
                    setBlock(new BlockPos(x + 2 + xx - xOffset - radius / 2, y + treeHeight + yy - yOffset + 3,
                            z + zz - zOffset), Blocks.LOG.getDefaultState(), blocks);
                    setBlock(new BlockPos(x + 2 + xx - xOffset - radius / 2, p_i46030_2_, z + zz - zOffset + 1),
                            Blocks.LOG.getDefaultState(), blocks);
                    setBlock(new BlockPos(x + 2 + xx - xOffset - radius / 2, p_i46030_2_, z + zz - zOffset - 1),
                            Blocks.LOG.getDefaultState(), blocks);
                ...
                if (rand.nextInt(4) == 0) {
                    ...
                    for (zz = -1; zz < 2; zz++)
                        for (xx = -1; xx < 2; xx++)
                            setBlock(
                                    new BlockPos(x + 2 + xx - xOffset - radius / 2,
                                            y + treeHeight - 10 + yy - yOffset + 2, z + zz - zOffset),
                                    Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false),
                                    blocks);
                    // Descending
                    for (int yyy = 0; yyy < 10; yyy++) {
                        ...
                        for (zz = -2; zz < 3; zz++)
                            for (xx = -2; xx < 3; xx++)
                                setBlock(
                                        new BlockPos(x + 2 + xx - xOffset - radius / 2,
                                                y + treeHeight - yyy + yy - yOffset + 2, z + zz - zOffset),
                                        Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false),
                                        blocks);
                        xx = xxx;
                        zz = zzz;
                        ...
                        setBlock(new BlockPos(x + 1 + xx - xOffset - radius / 2, p_i46030_2_, z + zz - zOffset),
                                Blocks.LOG.getDefaultState(), blocks);
                        setBlock(new BlockPos(x + 2 + xx - xOffset - radius / 2,
                                y + treeHeight + yy - yyy - yOffset + 3, z + zz - zOffset),
                                Blocks.LOG.getDefaultState(), blocks);
                        setBlock(new BlockPos(x + 2 + xx - xOffset - radius / 2, p_i46030_2_, z + zz - zOffset + 1),
                                Blocks.LOG.getDefaultState(), blocks);
                        setBlock(new BlockPos(x + 2 + xx - xOffset - radius / 2, p_i46030_2_, z + zz - zOffset - 1),
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        ...
        for (int zOff = -numDiag - currentEdgeRadius / 2; zOff <= -currentEdgeRadius / 2; zOff++) {
            ...
            for (int xOff = -numDiag - currentEdgeRadius / 2; xOff <= numDiag + currentEdgeRadius / 2; xOff++) {
                ...
                for (BlockPos yOff = world.getHeight(new BlockPos(x + xOff, 0, z + zOff)); yOff.getY() <
                        y; yOff = yOff.up()) // Fills the gaps under the crystal
        ...
        for (double yAngle = 0; yAngle < 2 * Math.PI; yAngle += Math.PI / 8.0) {
            ...
            for (double angle = 1.5 * Math.PI / 2.0; angle > -Math.PI / 6.0; angle -= Math.PI / 40.0) {
                ...
                int xx = (int) (xzRadius * Math.cos(yAngle));
                int zz = (int) (xzRadius * Math.sin(yAngle));
                int yyy = y + treeHeight + yy - yOffset + 2;

                world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yyy, z + zz - zOffset),
                        Blocks.LOG.getDefaultState(), 5); // meta
                world.setBlockState(new BlockPos(x + 3 + xx - xOffset - radius / 2, yyy, z + zz - zOffset),
                        Blocks.LOG.getDefaultState(), 5); // meta
                world.setBlockState(new BlockPos(x + 1 + xx - xOffset - radius / 2, yyy, z + zz - zOffset),
                        Blocks.LOG.getDefaultState(), 5); // meta
                world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yyy, z + zz - zOffset),
                        Blocks.LOG.getDefaultState(), 5); // meta
                world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yyy, z + zz - zOffset + 1),
                        Blocks.LOG.getDefaultState(), 5); // meta
                world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yyy, z + zz - zOffset - 1),
                        Blocks.LOG.getDefaultState(), 5); // meta
            ...
            if (rand.nextInt(4) == 0) {
                ...
                for (zz = -1; zz < 2; zz++)
                    for (xx = -1; xx < 2; xx++)
                        world.setBlockState(
                                new BlockPos(x + 2 + xx - xOffset - radius / 2, y + treeHeight - 10 + yy - yOffset + 2,
                                        z + zz - zOffset),
                                Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false), 5);
                // Descending
                for (int yyyy = 0; yyyy < 10; yyyy++) {
                    ...
                    for (zz = -2; zz < 3; zz++)
                        for (xx = -2; xx < 3; xx++)
                            world.setBlockState(
                                    new BlockPos(x + 2 + xx - xOffset - radius / 2,
                                            y + treeHeight - yyyy + yy - yOffset + 2, z + zz - zOffset),
                                    Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false), 5);
                    xx = xxx;
                    zz = zzz;
                    int yModified = yyy - yyyy;

                    world.setBlockState(new BlockPos(x + 2 + xx - xOffset - radius / 2, yModified, z + zz - zOffset),
                            Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(new BlockPos(x + 3 + xx - xOffset - radius / 2, yModified, z + zz - zOffset),
                            Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(new BlockPos(x + 1 + xx - xOffset - radius / 2, yModified, z + zz - zOffset),
                            Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(
                            new BlockPos(x + 2 + xx - xOffset - radius / 2, yModified + 1, z + zz - zOffset),
                            Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(
                            new BlockPos(x + 2 + xx - xOffset - radius / 2, yModified, z + zz - zOffset + 1),
                            Blocks.LOG.getDefaultState(), 5);
                    world.setBlockState(
                            new BlockPos(x + 2 + xx - xOffset - radius / 2, yModified, z + zz - zOffset - 1),
                            Blocks.LOG.getDefaultState(), 5);
