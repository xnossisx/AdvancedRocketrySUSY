                    ...
                    for (int y = 254; y >= 0; y--) {
                        ...
                        if (!isCraterIgnoredBlock(chunkPrimerIn.getBlockState(x, y, z).getBlock())) {
                            ...
                            for (int dist = 0; dist < inversePartialSquareRadius; dist++) {
                                if (y - dist > 2) {
                                    chunkPrimerIn.setBlockState(x, y - Math.min(large ? 15 : 11, dist), z,
                                ...
                                for (int dist = -1; dist < 9 * ridgeSize *
                                    ...
                                    if (y + dist < 255 && inverseRadius > -0.5 * radius)
                                        ...
                                        chunkPrimerIn.setBlockState(x, y + dist, z,
                                            ...
                                            rand.nextInt(Math.abs(inverseRadius + (int) (radius * 0.625)) + 1) == 0)
                                        chunkPrimerIn.setBlockState(x, y + dist, z,
                                                this.getBlockToPlace(world, chunkX, chunkZ, ores));
                            ...
                            if (inversePartialSquareRadius >= 0 && (y - inversePartialSquareRadius > 0)) {
                                ...
                                chunkPrimerIn.setBlockState(x,
                                        y - Math.min(large ? 16 : 12, inversePartialSquareRadius), z,
                                        this.getBlockToPlace(world, chunkX, chunkZ, ores));
                                chunkPrimerIn.setBlockState(x,
                                        y - 1 - Math.min(large ? 16 : 12, inversePartialSquareRadius), z,
                                        this.getBlockToPlace(world, chunkX, chunkZ, ores));
                            }
