...
public class WorldGenLargeCrystal extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, @Nonnull BlockPos pos) {
        ...
        IBlockState usedState = block.withProperty(BlockCrystal.CRYSTALPROPERTY,
        ...
        for (int zOff = -numDiag - currentEdgeRadius / 2; zOff <= -currentEdgeRadius / 2; zOff++) {
            ...
            for (int xOff = -numDiag - currentEdgeRadius / 2; xOff <= numDiag + currentEdgeRadius / 2; xOff++) {
                ...
                for (BlockPos yOff = world.getHeight(new BlockPos(x + xOff, y, z + zOff)); yOff.getY() <
        ...
        for (int zOff = -currentEdgeRadius / 2; zOff <= currentEdgeRadius / 2; zOff++) {
            for (int xOff = -numDiag - currentEdgeRadius / 2; xOff <= numDiag + currentEdgeRadius / 2; xOff++) {
                ...
                for (BlockPos yOff = world.getHeight(new BlockPos(x + xOff, y, z + zOff)); yOff.getY() < y; yOff.up()) // Fills
                                                                                                                       // the
                                                                                                                       // gaps
                                                                                                                       // under
                                                                                                                       // the
        ...
        for (int zOff = currentEdgeRadius / 2; zOff <= numDiag + currentEdgeRadius / 2; zOff++) {
            currentEdgeRadius--;
            for (int xOff = -numDiag - currentEdgeRadius / 2; xOff <= numDiag + currentEdgeRadius / 2; xOff++) {
                for (BlockPos yOff = world.getHeight(new BlockPos(x + xOff, y, z + zOff)); yOff.getY() < y; yOff.getY()) // Fills
                                                                                                                         // the
                                                                                                                         // gaps
                                                                                                                         // under
                                                                                                                         // the
        ...
        for (int yOff = 0; yOff < height; yOff++) {
            ...
            for (int zOff = -numDiag - currentEdgeRadius / 2; zOff <= -currentEdgeRadius / 2; zOff++) {
                ...
                for (int xOff = -numDiag - currentEdgeRadius / 2; xOff <= numDiag + currentEdgeRadius / 2; xOff++) {
                    setBlockState(world, new BlockPos(x + xOff + xShear * yOff, y + yOff, z + zOff + zShear * yOff),
                            usedState);
                }
                currentEdgeRadius++;
            }
