            ...
            if (!flag) {
                ...
                if (y < 256 - l - 1) {
                    ...
                    for (k1 = 0; k1 < l; ++k1) {
                        ...
                        if (world.isAirBlock(new BlockPos(x, y + k1, z)) ||
                                state2.getBlock().isLeaves(state2, world, new BlockPos(x, y + k1, z))) {
                            this.setBlockAndNotifyAdequately(world, new BlockPos(x, y + k1, z),
                                    AdvancedRocketryBlocks.blockCharcoalLog.getDefaultState()
