...
public class ItemJackHammer extends ItemTool {
    ...
    private static final Set<Block> items = Sets.newHashSet(Blocks.COBBLESTONE, Blocks.DOUBLE_STONE_SLAB,
            Blocks.STONE_SLAB, Blocks.STONE, Blocks.SANDSTONE, Blocks.MOSSY_COBBLESTONE, Blocks.IRON_ORE,
            Blocks.IRON_BLOCK, Blocks.COAL_ORE, Blocks.GOLD_BLOCK, Blocks.GOLD_BLOCK, Blocks.DIAMOND_ORE,
    ...
    public boolean getIsRepairable(@Nonnull ItemStack stackMe, ItemStack stackItem) {
        return OreDictionary.itemMatches(OreDictionary.getOres("stickTitanium").get(0), stackItem, false);// super.getIsRepairable(p_82789_1_,
                                                                                                          // p_82789_2_);
    }
    ...
    public float getDestroySpeed(@Nonnull ItemStack stack, IBlockState state) {
        return state.getMaterial() == Material.IRON || state.getMaterial() == Material.ROCK ||
                state.getMaterial() == MaterialGeode.geode ? this.efficiency : super.getDestroySpeed(stack, state);
    }
