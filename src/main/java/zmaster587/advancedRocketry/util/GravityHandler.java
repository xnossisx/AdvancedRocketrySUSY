...
public class GravityHandler implements IGravityManager {
    ...
    public static void applyGravity(Entity entity) {
        ...
        if ((!(entity instanceof EntityPlayer) && !(entity instanceof EntityFlying)) ||
                ...
                entity.motionY += multiplier;
            ...
            } else if (DimensionManager.getInstance().isDimensionCreated(entity.world.provider.getDimension()) ||
                    entity.world.provider instanceof WorldProviderSpace) {
                        ...
                        if (entity.world.provider instanceof IPlanetaryProvider)
                            ...
                            gravMult = DimensionManager.getInstance().getDimensionProperties(
                                    entity.world.provider.getDimension()).gravitationalMultiplier;
