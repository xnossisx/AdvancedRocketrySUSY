...
public class GuiPlanetButton extends GuiImageButton {
    ...
    public void drawButton(Minecraft minecraft, int par2, int par3, float f) {
        if (this.visible) {
            ...
            // RenderPlanetarySky.renderPlanetPubHelper(vertexbuffer, properties.getPlanetIcon(), (int) (x + newWidth),
            // (int) (y + newWidth), this.zLevel, newWidth, 1f, properties.getSolarTheta(), properties.hasAtmosphere(),
            // properties.skyColor, properties.ringColor, properties.isGasGiant(), properties.hasRings(),
            // properties.hasDecorators(), new float[]{0, 0, 0}, 1f);
            RenderPlanetarySky.renderPlanetPubHelper_old(vertexbuffer, properties.getPlanetIcon(), (int) (x + newWidth),
                    (int) (y + newWidth), this.zLevel, newWidth, 1f, properties.getSolarTheta(),
