...
public class TileSolarPanel extends TileInventoriedForgePowerMachine {
    ...
    public int getPowerPerOperation() {
        ...
        double insolationMultiplier = (world.provider.getDimension() == ARConfiguration.getCurrentConfig().spaceDimId) ?
        ...
        return (int) Math
                .min((1.0005d * 2d * ARConfiguration.getCurrentConfig().solarGeneratorMult * insolationMultiplier), 10);
    }
