...
public class SatelliteSpyTelescope extends SatelliteBase {
    ...
    public boolean performAction(EntityPlayer player, World world, BlockPos pos) {
         ...
         * EntityCameraMP entityClientCameramp = new EntityCameraMP(MinecraftServer.getServer(), world, "Camera", new
         * ItemInWorldManager(world));
         ...
         * // worldserver.theChunkProviderServer.loadChunk((int)entityplayermp1.posX >> 4, (int)entityplayermp1.posZ >>
         * 4);
         ...
         * 
         * 
         * //PacketDispatcher.sendPacketToPlayer(new Packet9Respawn(world.provider.dimensionId,
         * (byte)world.difficultySetting, world.getWorldInfo().getTerrainType(), world.getHeight(),
         * ((EntityPlayerMP)player).theItemInWorldManager.getGameType()), (Player) player);
         * ((EntityPlayerMP)player).playerNetServerHandler.setPlayerLocation(-300, 80, 200, 0, 87);
         * //((EntityPlayerMP)player).playerNetServerHandler.sendPacketToPlayer(new
         * Packet9Respawn(world.provider.dimensionId, (byte)world.difficultySetting,
         * world.getWorldInfo().getTerrainType(), world.getHeight(),
         * ((EntityPlayerMP)player).theItemInWorldManager.getGameType()));
         * //((EntityPlayerMP)player).playerNetServerHandler.sendPacketToPlayer(new Packet6SpawnPosition(0, 80,0));
         * //TODO: fix
         * 
         * 
         * 
         ...
         * 
         * MinecraftServer.getServerConfigurationManager(MinecraftServer.getServer()).playerEntityList.add(
         * entityClientCameramp);
         * }
         * else {
         * 
         * 
