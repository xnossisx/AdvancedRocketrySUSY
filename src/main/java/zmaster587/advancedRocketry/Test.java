...
public class Test {
    ...
    public static void main(String[] args) {
         ...
         * //if(thing2(pos) != i)
         * System.out.println(String.format("input id: %d, output id: %d,  coords: %d %d", i, thing2(pos), pos.getX(),
         * pos.getZ()));
         * }
         */
    }
    ...
    public static int thing2(BlockPos pos) {
        int x = pos.getX();
        int z = pos.getZ();
        x = (x - ARConfiguration.getCurrentConfig().stationSize / 2) /
                (2 * ARConfiguration.getCurrentConfig().stationSize);
        z = (z - ARConfiguration.getCurrentConfig().stationSize / 2) /
                (2 * ARConfiguration.getCurrentConfig().stationSize);
    ...
    public static BlockPos registerSpaceObject(int stationId) {
        ...
        return new BlockPos(
                ...
                0, 2 * ARConfiguration.getCurrentConfig().stationSize * z +
                        ARConfiguration.getCurrentConfig().stationSize / 2);
    }
}
