...
public class AdvancedRocketry {
    ...
    public void registerItems(RegistryEvent.Register<Item> evt) {
        ...
        AdvancedRocketryItems.itemSatellitePrimaryFunction = new ItemIngredient(7).setTranslationKey("advancedrocketry:satellitePrimaryFunction").setCreativeTab(tabAdvRocketry);
        ...
        AdvancedRocketryItems.itemWeatherController = new ItemWeatherController().setTranslationKey("weatherController").setCreativeTab(tabAdvRocketry);
    ...
    public void registerBlocks(RegistryEvent.Register<Block> evt) {
        ...
        if (ARConfiguration.getCurrentConfig().enableTerraforming)
            ...
            AdvancedRocketryBlocks.blockAtmosphereTerraformer = new BlockAtmosphereTerraformer(TileAtmosphereTerraformer.class, GuiHandler.guiId.MODULARNOINV.ordinal()).setTranslationKey("atmosphereTerraformer").setCreativeTab(tabAdvRocketry).setHardness(3f);
        ...
        AdvancedRocketryBlocks.blockServiceMonitor = new RotatableBlock(Material.IRON).setTranslationKey("servicemonitor").setCreativeTab(tabAdvRocketry).setHardness(1).setResistance(1f);
        AdvancedRocketryBlocks.blockInvHatch = new BlockInvHatch(Material.IRON).setTranslationKey("invhatch").setCreativeTab(tabAdvRocketry).setHardness(1).setResistance(1f);
        //Assembly machines
        ...
        AdvancedRocketryBlocks.blockTerraformingTerminal = new BlockTileTerraformer(TileTerraformingTerminal.class, GuiHandler.guiId.MODULAR.ordinal()).setCreativeTab(tabAdvRocketry).setHardness(3f).setTranslationKey("terraformingTerminal");
        AdvancedRocketryBlocks.blockServiceStation = new BlockTile(TileRocketServiceStation.class, GuiHandler.guiId.MODULARNOINV.ordinal()).setCreativeTab(tabAdvRocketry).setHardness(3f).setTranslationKey("serviceStation");
        ...
        AdvancedRocketryFluids.fluidOxygen = new Fluid("oxygen", notFlowing, flowing).setTranslationKey("oxygen").setGaseous(true).setDensity(-1000).setViscosity(1000).setColor(0xFF6CE2FF);
        AdvancedRocketryFluids.fluidHydrogen = new Fluid("hydrogen", notFlowing, flowing).setTranslationKey("hydrogen").setGaseous(true).setDensity(-1000).setViscosity(1000).setColor(0xFFDBC1C1);
        AdvancedRocketryFluids.fluidNitrogen = new Fluid("nitrogen", notFlowing, flowing).setTranslationKey("nitrogen").setGaseous(true).setDensity(-1000).setViscosity(1000).setColor(0xFFDFE5FE);
        AdvancedRocketryFluids.fluidRocketFuel = new Fluid("rocketFuel", notFlowing, flowing).setTranslationKey("rocketFuel").setGaseous(false).setLuminosity(2).setDensity(800).setViscosity(1500).setColor(0xFFE5D884);
        AdvancedRocketryFluids.fluidEnrichedLava = new Fluid("enrichedLava", new ResourceLocation("advancedrocketry:blocks/fluid/lava_still"), new ResourceLocation("advancedrocketry:blocks/fluid/lava_flow")).setTranslationKey("enrichedLava").setLuminosity(15).setDensity(3000).setViscosity(6000).setTemperature(1300).setColor(0xFFFFFFFF);
